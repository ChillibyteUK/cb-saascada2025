...
<section class="home_intro">
    <div class="container-xl pb-5 mb-5">
        <img src="<?= esc_url( get_stylesheet_directory_uri() ); ?>/img/dna.svg" alt="" class="home_intro__dna">
        <img src="<?= esc_url( get_stylesheet_directory_uri() ); ?>/img/home_intro_lines.svg" alt="" class="home_intro__lines d-none d-md-block" width="692.78" height="742.34">
